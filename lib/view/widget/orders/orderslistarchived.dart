...
import 'package:tataboq_app/view/screen/orders/dialograting.dart';

class CardOrderListArchived extends GetView<OrdersArchivedController> {
  final OrdersModel listdata;
  const CardOrderListArchived({super.key, required this.listdata});
